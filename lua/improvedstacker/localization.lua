...
localify.Bind( "ru", prefix.."language_en",    "Русский" )
...
-- Tool Settings
localify.Bind( "ru", prefix.."name",                     "Stacker - Improved" )
localify.Bind( "ru", prefix.."desc",                     "Easily stack duplicated props in any direction" )
localify.Bind( "ru", prefix.."left",                     "Create a stack" )
localify.Bind( "ru", prefix.."shift_left",               "Increase stack size" )
localify.Bind( "ru", prefix.."right",                    "Create a single prop" )
localify.Bind( "ru", prefix.."shift_right",              "Decrease stack size" )
localify.Bind( "ru", prefix.."reload",                   "Change stack direction" )
localify.Bind( "ru", "Undone_stacker_improved",          "Undone stacked prop(s)" )
-- Errors
localify.Bind( "ru", prefix.."error_blocked_by_server",  "The server has blocked you from changing this console variable" )
localify.Bind( "ru", prefix.."error_not_admin",          "You must be in the 'admin' usergroup to change this console variable" )
localify.Bind( "ru", prefix.."error_invalid_argument",   "You must enter a valid number value" )
localify.Bind( "ru", prefix.."error_max_per_stack",      "The max props that can be stacked at once is limited to " )
localify.Bind( "ru", prefix.."error_too_quick",          "You are using stacker too quickly" )
localify.Bind( "ru", prefix.."error_max_per_player",     "Stacker prop limit reached" )
localify.Bind( "ru", prefix.."error_not_in_world",       "Stacked props must be spawned within the world" )
localify.Bind( "ru", prefix.."error_max_constraints",    "Failed to create constraint, most likely ran out of entity slots" )
-- Labels
localify.Bind( "ru", prefix.."label_presets",            "Stacker Presets: " )
localify.Bind( "ru", prefix.."label_relative",           "Stack relative to: " )
localify.Bind( "ru", prefix.."label_direction",          "Stack direction: " )
localify.Bind( "ru", prefix.."label_count",              "Stack size" )
localify.Bind( "ru", prefix.."label_reset_offsets",      "Reset offsets" )
localify.Bind( "ru", prefix.."label_reset_angles",       "Reset angles" )
localify.Bind( "ru", prefix.."label_show_settings",      "Click to show settings" )
localify.Bind( "ru", prefix.."label_hide_settings",      "Click to hide settings" )
localify.Bind( "ru", prefix.."label_x",                  "X  (-back, +front)" )
localify.Bind( "ru", prefix.."label_y",                  "Y  (-left, +right)" )
localify.Bind( "ru", prefix.."label_z",                  "Z  (-down, +up)" )
localify.Bind( "ru", prefix.."label_pitch",              "Pitch  (-down, +up)" )
localify.Bind( "ru", prefix.."label_yaw",                "Yaw   (-left, +right)" )
localify.Bind( "ru", prefix.."label_roll",               "Roll    (-left, +right)" )
localify.Bind( "ru", prefix.."label_language",           "Language: " )
localify.Bind( "ru", prefix.."label_credits",            "" )
localify.Bind( "ru", prefix.."label_max_per_stack",      "Stack size" )
localify.Bind( "ru", prefix.."label_max_per_player",     "Props per player" )
localify.Bind( "ru", prefix.."label_max_offsetx",        "Maximum X offset" )
localify.Bind( "ru", prefix.."label_max_offsety",        "Maximum Y offset" )
localify.Bind( "ru", prefix.."label_max_offsetz",        "Maximum Z offset" )
localify.Bind( "ru", prefix.."label_delay",              "Delay" )
localify.Bind( "ru", prefix.."label_opacity",            "Opacity" )
-- Checkboxes
localify.Bind( "ru", prefix.."checkbox_freeze",          "Freeze stacked props" )
localify.Bind( "ru", prefix.."checkbox_weld",            "Weld stacked props" )
localify.Bind( "ru", prefix.."checkbox_nocollide",       "No-Collide stacked props with each other" )
localify.Bind( "ru", prefix.."checkbox_nocollide_all",   "No-Collide stacked props with EVERYTHING" )
localify.Bind( "ru", prefix.."checkbox_use_shift_key",   "Change stack size with SHIFT + left/right-click" )
localify.Bind( "ru", prefix.."checkbox_relative",        "Stack relative to new rotation" )
localify.Bind( "ru", prefix.."checkbox_material",        "Apply material" )
localify.Bind( "ru", prefix.."checkbox_color",           "Apply color" )
localify.Bind( "ru", prefix.."checkbox_physprop",        "Apply physical properties" )
localify.Bind( "ru", prefix.."checkbox_ghost",           "Ghost all props in the stack" )
localify.Bind( "ru", prefix.."checkbox_halo",            "Add halos to ghosted props" )
localify.Bind( "ru", prefix.."checkbox_halo_color",      "Halo color" )
localify.Bind( "ru", prefix.."checkbox_axis",            "Draw XYZ axis" )
localify.Bind( "ru", prefix.."checkbox_axis_labels",     "Draw XYZ axis labels" )
localify.Bind( "ru", prefix.."checkbox_axis_angles",     "Draw XYZ axis angles" )
localify.Bind( "ru", prefix.."checkbox_stayinworld",     "Stay in world" )
-- Comboboxes
localify.Bind( "ru", prefix.."combobox_world",           "World" )
localify.Bind( "ru", prefix.."combobox_prop",            "Prop" )
localify.Bind( "ru", prefix.."combobox_direction_up",    "Up" )
localify.Bind( "ru", prefix.."combobox_direction_down",  "Down" )
localify.Bind( "ru", prefix.."combobox_direction_front", "Front" )
localify.Bind( "ru", prefix.."combobox_direction_back",  "Back" )
localify.Bind( "ru", prefix.."combobox_direction_right", "Right" )
localify.Bind( "ru", prefix.."combobox_direction_left",  "Left" )
localify.Bind( "ru", prefix.."combobox_default",         "Default" )
localify.Bind( "ru", prefix.."combobox_sandbox",         "Sandbox" )
localify.Bind( "ru", prefix.."combobox_darkrp",          "DarkRP" )
localify.Bind( "ru", prefix.."combobox_singleplayer",    "Singleplayer" )
-- HUD
localify.Bind( "ru", prefix.."hud_front",                "Front" )
localify.Bind( "ru", prefix.."hud_right",                "Right" )
localify.Bind( "ru", prefix.."hud_up",                   "Up" )
-- Help
localify.Bind( "ru", prefix.."help_max_per_player",      "Maximum stacked props each player is limited to." )
localify.Bind( "ru", prefix.."help_max_per_stack",       "Maximum props per stack (left-click)." )
localify.Bind( "ru", prefix.."help_delay",               "Delay (in seconds) between each Stacker use (left/right-click)" )
localify.Bind( "ru", prefix.."help_max_offsetx",         "Maximum distance between stacked props (X-axis)." )
localify.Bind( "ru", prefix.."help_max_offsety",         "Maximum distance between stacked props (Y-axis)." )
localify.Bind( "ru", prefix.."help_max_offsetz",         "Maximum distance between stacked props (Z-axis)." )
localify.Bind( "ru", prefix.."help_freeze",              "Stacked props are frozen when spawned." )
localify.Bind( "ru", prefix.."help_weld",                "Stacked props are welded to each other when spawned." )
localify.Bind( "ru", prefix.."help_nocollide",           "Stacked props won't collide with other stacked props." )
localify.Bind( "ru", prefix.."help_nocollide_all",       "Stacked props won't collide with anything except players, NPCs, vehicles, and the world." )
localify.Bind( "ru", prefix.."help_stayinworld",         "Prevents stacked props from being created outside of the map." )
-- Warnings
localify.Bind( "ru", prefix.."warning_max_per_player",   "Primarily for Roleplay gamemodes. For Sandbox gamemodes, this should generally be unlimited (-1)." )
localify.Bind( "ru", prefix.."warning_max_offsetx",      "Primarily for Roleplay gamemodes. Don't modify unless you know what you're doing." )
localify.Bind( "ru", prefix.."warning_max_offsety",      "Primarily for Roleplay gamemodes. Don't modify unless you know what you're doing." )
localify.Bind( "ru", prefix.."warning_max_offsetz",      "Primarily for Roleplay gamemodes. Don't modify unless you know what you're doing." )
localify.Bind( "ru", prefix.."warning_freeze",           "For DarkRP." )
localify.Bind( "ru", prefix.."warning_weld",             "For DarkRP." )
localify.Bind( "ru", prefix.."warning_nocollide",        "For DarkRP." )
localify.Bind( "ru", prefix.."warning_nocollide_all",    "DO NOT CHANGE WHILE THE SERVER IS RUNNING. This uses the GM.ShouldCollide hook and is experimental. It works and is guaranteed to stop crashes from Stacker, but needs more testing." )
